        ...
        public Styles()
        {
            ...
            Add(new Style(typeof(Button))
            {
                Setters =
                {
                    ...
                    new() { Property = Button.FontFamilyProperty, Value = "Poppins" },
            ...
            Add(new Style(typeof(DatePicker))
            {
                Setters =
                {
                    ...
                    new() { Property = DatePicker.FontFamilyProperty, Value = "Poppins" },
            ...
            Add(new Style(typeof(Editor))
            {
                Setters =
                {
                    ...
                    new() { Property = Editor.FontFamilyProperty, Value = "Poppins" },
            ...
            Add(new Style(typeof(Entry))
            {
                Setters =
                {
                    ...
                    new() { Property = Entry.FontFamilyProperty, Value = "Poppins" },
            ...
            Add(new Style(typeof(Label))
            {
                Setters =
                {
                    new() { Property = Label.TextColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("White"), AppTheme.Light or _ => AppResource<Color>("Gray600") } },
                    new() { Property = Label.FontFamilyProperty, Value = "Poppins" },
            ...
            Add(new Style(typeof(Picker))
            {
                Setters =
                {
                    ...
                    new() { Property = Picker.FontFamilyProperty, Value = "Poppins" },
            ...
            Add(new Style(typeof(RadioButton))
            {
                Setters =
                {
                    ...
                    new() { Property = RadioButton.FontFamilyProperty, Value = "Poppins" },
            ...
            Add(new Style(typeof(SearchBar))
            {
                Setters =
                {
                    ...
                    new() { Property = SearchBar.FontFamilyProperty, Value = "Poppins" },
            ...
            Add(new Style(typeof(SearchHandler))
            {
                Setters =
                {
                    ...
                    new() { Property = SearchHandler.FontFamilyProperty, Value = "Poppins" },
            ...
            Add(new Style(typeof(TimePicker))
            {
                Setters =
                {
                    ...
                    new() { Property = TimePicker.FontFamilyProperty, Value = "Poppins" },
            ...
            Add(new Style(typeof(Shell))
            {
                ...
                Setters =
                {
                    new() { Property = Shell.BackgroundColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("Gray950"), AppTheme.Light or _ => AppResource<Color>("White") } },
                    ...
                    new() { Property = Shell.TabBarForegroundColorProperty, Value = AppResource<Color>("Primary") },
                    new() { Property = Shell.TitleColorProperty, Value = AppResource<Color>("Primary") },
                    new() { Property = Shell.ForegroundColorProperty, Value = AppResource<Color>("Primary") },
                    new() { Property = Shell.TabBarUnselectedColorProperty, Value = Color.FromArgb("#e0e0e0") },
                },
            });
            Add(new Style(typeof(NavigationPage))
            {
                Setters =
                {
                    new() { Property = NavigationPage.BarBackgroundColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("Gray950"), AppTheme.Light or _ => AppResource<Color>("White") } },
