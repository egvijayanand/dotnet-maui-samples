        ...
        public Styles()
        {
            ...
            Add(new Style(typeof(Button))
            {
                Setters =
                {
                    ...
                    new() { Property = Button.MinimumHeightRequestProperty, Value = 44 },
                    new() { Property = Button.MinimumWidthRequestProperty, Value = 44 },
                    new Setter()
                    {
            ...
            Add(new Style(typeof(CheckBox))
            {
                Setters =
                {
                    ...
                    new() { Property = CheckBox.MinimumHeightRequestProperty, Value = 44 },
                    new() { Property = CheckBox.MinimumWidthRequestProperty, Value = 44 },
                    new Setter()
                    {
                        Property = VisualStateManager.VisualStateGroupsProperty,
                        Value = CreateVisualStateGroupList(new[]
            ...
            Add(new Style(typeof(DatePicker))
            {
                Setters =
                {
                    ...
                    new() { Property = DatePicker.MinimumHeightRequestProperty, Value = 44 },
                    new() { Property = DatePicker.MinimumWidthRequestProperty, Value = 44 },
                    new Setter()
                    {
                        Property = VisualStateManager.VisualStateGroupsProperty,
                        Value = CreateVisualStateGroupList(new[]
            ...
            Add(new Style(typeof(Editor))
            {
                Setters =
                {
                    ...
                    new() { Property = Editor.MinimumHeightRequestProperty, Value = 44 },
                    new() { Property = Editor.MinimumWidthRequestProperty, Value = 44 },
                    new Setter()
                    {
                        Property = VisualStateManager.VisualStateGroupsProperty,
                        Value = CreateVisualStateGroupList(new[]
            ...
            Add(new Style(typeof(Entry))
            {
                Setters =
                {
                    ...
                    new() { Property = Entry.MinimumHeightRequestProperty, Value = 44 },
                    new() { Property = Entry.MinimumWidthRequestProperty, Value = 44 },
                    new Setter()
                    {
                        Property = VisualStateManager.VisualStateGroupsProperty,
                        Value = CreateVisualStateGroupList(new[]
            ...
            Add(new Style(typeof(ImageButton))
            {
                Setters =
                {
                    ...
                    new() { Property = ImageButton.MinimumHeightRequestProperty, Value = 44 },
                    new() { Property = ImageButton.MinimumWidthRequestProperty, Value = 44 },
                    new Setter()
                    {
                        Property = VisualStateManager.VisualStateGroupsProperty,
                        Value = CreateVisualStateGroupList(new[]
            ...
            Add(new Style(typeof(Label))
            {
                Setters =
                {
                    ...
                    new() { Property = Label.BackgroundColorProperty, Value = Transparent },
            ...
            Add(new Style(typeof(Picker))
            {
                Setters =
                {
                    ...
                    new() { Property = Picker.MinimumHeightRequestProperty, Value = 44 },
                    new() { Property = Picker.MinimumWidthRequestProperty, Value = 44 },
                    new Setter()
                    {
                        Property = VisualStateManager.VisualStateGroupsProperty,
                        Value = CreateVisualStateGroupList(new[]
            ...
            Add(new Style(typeof(RadioButton))
            {
                Setters =
                {
                    new() { Property = RadioButton.BackgroundColorProperty, Value = Transparent },
                    ...
                    new() { Property = RadioButton.MinimumHeightRequestProperty, Value = 44 },
                    new() { Property = RadioButton.MinimumWidthRequestProperty, Value = 44 },
                    new Setter()
                    {
                        Property = VisualStateManager.VisualStateGroupsProperty,
                        Value = CreateVisualStateGroupList(new[]
            ...
            Add(new Style(typeof(SearchBar))
            {
                Setters =
                {
                    ...
                    new() { Property = SearchBar.MinimumHeightRequestProperty, Value = 44 },
                    new() { Property = SearchBar.MinimumWidthRequestProperty, Value = 44 },
                    new Setter()
                    {
                        Property = VisualStateManager.VisualStateGroupsProperty,
                        Value = CreateVisualStateGroupList(new[]
            ...
            Add(new Style(typeof(TimePicker))
            {
                Setters =
                {
                    ...
                    new() { Property = TimePicker.BackgroundColorProperty, Value = Transparent },
                    new() { Property = TimePicker.FontFamilyProperty, Value = "OpenSansRegular" },
                    new() { Property = TimePicker.FontSizeProperty, Value = 14 },
                    new() { Property = TimePicker.MinimumHeightRequestProperty, Value = 44 },
                    new() { Property = TimePicker.MinimumWidthRequestProperty, Value = 44 },
                    new Setter()
                    {
                        Property = VisualStateManager.VisualStateGroupsProperty,
                        Value = CreateVisualStateGroupList(new[]
