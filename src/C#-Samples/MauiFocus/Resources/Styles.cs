    ...
    public partial class Styles : ResourceDictionary
    {
        public Styles()
        {
            ...
            Add(new Style(typeof(IndicatorView))
            {
                Setters =
                {
                    new() { Property = IndicatorView.IndicatorColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("DarkGray"), AppTheme.Light or _ => AppResource<Color>("LightGray") } },
                    new() { Property = IndicatorView.SelectedIndicatorColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("LightGray"), AppTheme.Light or _ => AppResource<Color>("DarkGray") } },
                },
            });
            Add(new Style(typeof(Border))
            {
                Setters =
                {
                    new() { Property = Border.StrokeProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("DarkGray"), AppTheme.Light or _ => AppResource<Color>("LightGray") } },
            ...
            Add(new Style(typeof(BoxView))
            {
                Setters =
                {
                    new() { Property = BoxView.ColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("LightGray"), AppTheme.Light or _ => AppResource<Color>("DarkGray") } },
                },
            });
                                    ...
                                    new VisualState()
                                    {
                                        ...
                                        Setters =
                                        {
                                            new Setter()
                                            {
                                                ...
                                                Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("LightGray"), AppTheme.Light or _ => AppResource<Color>("DarkGray") },
                                            },
                                            new Setter()
                                            {
                                                Property = Button.BackgroundColorProperty,
                                                Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("DarkGray"), AppTheme.Light or _ => AppResource<Color>("LightGray") },
                                            },
                                        },
                                    },
                                },
            ...
            Add(new Style(typeof(CheckBox))
            {
                Setters =
                {
                    ...
                    new() { Property = CheckBox.BackgroundColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("Black"), AppTheme.Light or _ => AppResource<Color>("White") } },
                    new Setter()
                    {
                        Property = VisualStateManager.VisualStateGroupsProperty,
                        Value = CreateVisualStateGroupList(new[]
            ...
            Add(new Style(typeof(DatePicker))
            {
                Setters =
                {
                    new() { Property = DatePicker.TextColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("White"), AppTheme.Light or _ => AppResource<Color>("Black") } },
            ...
            Add(new Style(typeof(Editor))
            {
                Setters =
                {
                    ...
                    new() { Property = Editor.PlaceholderColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("DarkGray"), AppTheme.Light or _ => AppResource<Color>("LightGray") } },
                    new Setter()
                    {
                        Property = VisualStateManager.VisualStateGroupsProperty,
                        Value = CreateVisualStateGroupList(new[]
            ...
            Add(new Style(typeof(Entry))
            {
                Setters =
                {
                    ...
                    new() { Property = Entry.PlaceholderColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("DarkGray"), AppTheme.Light or _ => AppResource<Color>("LightGray") } },
                    new Setter()
                    {
                        Property = VisualStateManager.VisualStateGroupsProperty,
                        Value = CreateVisualStateGroupList(new[]
            ...
            Add(new Style(typeof(Frame))
            {
                Setters =
                {
                    ...
                    new() { Property = MauiFrame.BorderColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("DarkGray"), AppTheme.Light or _ => AppResource<Color>("LightGray") } },
            ...
            Add(new Style(typeof(Label))
            {
                Setters =
                {
                    new() { Property = Label.TextColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("White"), AppTheme.Light or _ => AppResource<Color>("Black") } },
            ...
            Add(new Style(typeof(ListView))
            {
                Setters =
                {
                    new() { Property = ListView.SeparatorColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("DarkGray"), AppTheme.Light or _ => AppResource<Color>("LightGray") } },
                    new() { Property = ListView.RefreshControlColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("LightGray"), AppTheme.Light or _ => AppResource<Color>("DarkGray") } },
                },
            });
            Add(new Style(typeof(Picker))
            {
                Setters =
                {
                    new() { Property = Picker.TextColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("White"), AppTheme.Light or _ => AppResource<Color>("Black") } },
                    new() { Property = Picker.TitleColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("LightGray"), AppTheme.Light or _ => AppResource<Color>("DarkGray") } },
            ...
            Add(new Style(typeof(RefreshView))
            {
                Setters =
                {
                    new() { Property = RefreshView.RefreshColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("LightGray"), AppTheme.Light or _ => AppResource<Color>("DarkGray") } },
                },
            });
            Add(new Style(typeof(SearchBar))
            {
                Setters =
                {
                    new() { Property = SearchBar.TextColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("White"), AppTheme.Light or _ => AppResource<Color>("Black") } },
                    new() { Property = SearchBar.PlaceholderColorProperty, Value = AppResource<Color>("MidGray") },
                    new() { Property = SearchBar.CancelButtonColorProperty, Value = AppResource<Color>("MidGray") },
            ...
            Add(new Style(typeof(SearchHandler))
            {
                Setters =
                {
                    new() { Property = SearchHandler.TextColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("White"), AppTheme.Light or _ => AppResource<Color>("Black") } },
                    new() { Property = SearchHandler.PlaceholderColorProperty, Value = AppResource<Color>("MidGray") },
            ...
            Add(new Style(typeof(Slider))
            {
                Setters =
                {
                    ...
                    new() { Property = Slider.MaximumTrackColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("DarkGray"), AppTheme.Light or _ => AppResource<Color>("LightGray") } },
                                ...
                                States =
                                {
                                    ...
                                    new VisualState()
                                    {
                                        ...
                                        Setters =
                                        {
                                            ...
                                            {
                                                Property = Switch.OnColorProperty,
                                                Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("LightGray"), AppTheme.Light or _ => AppResource<Color>("Light") },
                                            },
                                            new Setter()
                                            {
                                                Property = Switch.ThumbColorProperty,
            ...
            Add(new Style(typeof(TimePicker))
            {
                Setters =
                {
                    new() { Property = TimePicker.TextColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("White"), AppTheme.Light or _ => AppResource<Color>("Black") } },
            ...
            Add("BaseStyle", new Style(typeof(Element))
            {
                Setters =
                {
                    new() { Property = Shell.BackgroundColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("Black"), AppTheme.Light or _ => AppResource<Color>("Primary") } },
                    new() { Property = Shell.ForegroundColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("White"), AppTheme.Light or _ => AppResource<Color>("Primary") } },
                    new() { Property = Shell.TitleColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("White"), AppTheme.Light or _ => AppResource<Color>("LightGray") } },
                    new() { Property = Shell.DisabledColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("DarkGray"), AppTheme.Light or _ => AppResource<Color>("LightGray") } },
                    new() { Property = Shell.UnselectedColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("DarkGray"), AppTheme.Light or _ => AppResource<Color>("LightGray") } },
                    ...
                    new() { Property = Shell.TabBarUnselectedColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("DarkGray"), AppTheme.Light or _ => AppResource<Color>("LightGray") } },
                },
            });
            Add(new Style(typeof(ShellItem))
            {
                BasedOn = (Style)this["BaseStyle"],
                ApplyToDerivedTypes = true,
            });
            Add(new Style(typeof(NavigationPage))
            {
                Setters =
                {
                    new() { Property = NavigationPage.BarBackgroundColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("Black"), AppTheme.Light or _ => AppResource<Color>("Primary") } },
                    new() { Property = NavigationPage.BarTextColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("White"), AppTheme.Light or _ => AppResource<Color>("LightGray") } },
                    new() { Property = NavigationPage.IconColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("White"), AppTheme.Light or _ => AppResource<Color>("LightGray") } },
                },
            });
            Add(new Style(typeof(TabbedPage))
            {
                Setters =
                {
                    new() { Property = TabbedPage.BarBackgroundColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("Black"), AppTheme.Light or _ => AppResource<Color>("White") } },
                    ...
                    new() { Property = TabbedPage.UnselectedTabColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("DarkGray"), AppTheme.Light or _ => AppResource<Color>("LightGray") } },
                    new() { Property = TabbedPage.SelectedTabColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("LightGray"), AppTheme.Light or _ => AppResource<Color>("DarkGray") } },
                },
            });
        }
    }
