namespace MauiFinance
{
    public partial class AppColors : ResourceDictionary
    {
        public AppColors()
        {
            Add("PrimaryBackground", Color.FromArgb("#EDF4FC"));
            Add("SeconaryBackground", Color.FromArgb("#E5E8F9"));
            Add("PrimaryBackgroundBrush", new SolidColorBrush((Color)this["PrimaryBackground"]));
            Add("SeconaryBackgroundBrush", new SolidColorBrush((Color)this["SeconaryBackground"]));
            Add("Primary", Color.FromArgb("#3D4785"));
