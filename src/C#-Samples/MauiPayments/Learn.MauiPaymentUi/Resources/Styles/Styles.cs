        ...
        public Styles()
        {
            ...
            Add(new Style(typeof(NavigationPage))
            {
                Setters =
                {
                    ...
                    new() { Property = NavigationPage.BarTextColorProperty, Value = Application.Current.RequestedTheme switch { AppTheme.Dark => AppResource<Color>("White"), AppTheme.Light or _ => AppResource<Color>("White") } },
