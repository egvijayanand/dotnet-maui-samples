...
using Maui.CommunityToolkit.Behaviors.Internals;
using DateCalculator.Core;
using PreserveAttribute = DateCalculator.Core.PreserveAttribute;

#nullable enable

namespace Maui.CommunityToolkit.Behaviors
{
    /// <summary>
